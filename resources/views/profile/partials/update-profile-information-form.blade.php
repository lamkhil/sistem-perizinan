                ...
                <div class="mt-3 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                    <div class="flex items-start">
                        ...
                        <div class="flex-1">
                            ...
                            <button form="send-verification" class="text-sm text-primary-600 hover:text-primary-700 font-medium underline focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 rounded">
        ...
        <div class="flex items-center justify-end gap-4 pt-4 border-t border-gray-200">
            @if (session('status') === 'profile-updated')
                ...
                >
                    ...
                    <p class="text-sm font-medium text-green-800">Berhasil disimpan</p>
                </div>
            @endif
