...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="field-data-pemohon">
                                    ...
                                    <textarea id="alamat_perusahaan" name="alamat_perusahaan"
                                        class="mt-1 block w-full border-gray-300 focus:border-primary-500 focus:ring-primary-500 rounded-md shadow-sm" required><?php echo e(old('alamat_perusahaan')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="field-data-pemohon">
                                    ...
                                    <input id="modal_usaha" name="modal_usaha" type="number"
                                        class="mt-1 block w-full border-gray-300 focus:border-primary-500 focus:ring-primary-500 rounded-md shadow-sm"
                                        value="<?php echo e(old('modal_usaha')); ?>" required />
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input id="jangka_waktu" name="jangka_waktu" type="number"
                                    class="mt-1 block w-full border-gray-300 focus:border-primary-500 focus:ring-primary-500 rounded-md shadow-sm"
                                    value="<?php echo e(old('jangka_waktu')); ?>" placeholder="Contoh: 2" />
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input id="no_telephone" name="no_telephone" type="text"
                                        class="mt-1 block w-full border-gray-300 focus:border-primary-500 focus:ring-primary-500 rounded-md shadow-sm"
                                        value="<?php echo e(old('no_telephone')); ?>" placeholder="Masukkan nomor telephone atau email" />
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div>
                                        ...
                                        <textarea id="keterangan_terbit" name="keterangan_terbit"
                                            class="mt-1 block w-full border-gray-300 focus:border-primary-500 focus:ring-primary-500 rounded-md shadow-sm"><?php echo e(old('keterangan_terbit')); ?></textarea>
