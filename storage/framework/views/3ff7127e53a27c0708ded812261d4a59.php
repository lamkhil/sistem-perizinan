...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <select name="verifikasi_pd_teknis" id="verifikasi_pd_teknis"
                                        class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm <?php echo e($isDisabled(['pd_teknis']) ? 'bg-gray-100' : ''); ?>" <?php echo e($isDisabled(['pd_teknis']) ? 'disabled' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <textarea id="keterangan_menghubungi" name="keterangan_menghubungi"
                                        class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"><?php echo e(old('keterangan_menghubungi')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input id="status_menghubungi" name="status_menghubungi" type="text"
                                        class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"
                                        value="<?php echo e(old('status_menghubungi')); ?>" />
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <textarea id="keterangan_perbaikan" name="keterangan_perbaikan"
                                        class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"><?php echo e(old('keterangan_perbaikan')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <select name="verifikasi_dpmptsp" id="verifikasi_dpmptsp"
                                        class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm <?php echo e($isDisabled(['dpmptsp']) ? 'bg-gray-100' : ''); ?>" <?php echo e($isDisabled(['dpmptsp']) ? 'disabled' : ''); ?>>
                                        <option value="">-- Pilih Status --</option>
                                        <?php $__currentLoopData = $verificationStatusOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <textarea id="keterangan_terbit" name="keterangan_terbit"
                                        class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"><?php echo e(old('keterangan_terbit')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input id="pemroses_dan_tgl_surat" name="pemroses_dan_tgl_surat" type="text"
                                        class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm <?php echo e($isReadOnly(['dpmptsp']) ? 'bg-gray-100' : ''); ?>"
                                        value="<?php echo e(old('pemroses_dan_tgl_surat')); ?>" <?php echo e($isReadOnly(['dpmptsp']) ? 'readonly' : ''); ?> />
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <textarea id="keterangan" name="keterangan"
                                        class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm <?php echo e($isReadOnly(['dpmptsp']) ? 'bg-gray-100' : ''); ?>" <?php echo e($isReadOnly(['dpmptsp']) ? 'readonly' : ''); ?>><?php echo e(old('keterangan')); ?></textarea>
