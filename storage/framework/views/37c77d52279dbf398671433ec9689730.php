            ...
            <form action="<?php echo e(route('login')); ?>" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <div class="captcha-container mb-2">
                        <img id="captcha-image" src="<?php echo e(captcha_src('flat')); ?>" alt="Captcha" onerror="this.onerror=null; window.location.reload();" style="border-radius: 8px; cursor: pointer;">
                    </div>
                    <div class="input-container">
                        <input 
                            type="text" 
