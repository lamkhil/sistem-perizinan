    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo e(\Illuminate\Support\Str::limit($permohonan->no_permohonan ?? '', 15)); ?></td>
                <td><?php echo e(\Illuminate\Support\Str::limit($permohonan->no_proyek ?? '', 15)); ?></td>
                ...
                <td><?php echo e(\Illuminate\Support\Str::limit($permohonan->sektor ?? '', 12)); ?></td>
                ...
                <td>
                    ...
                    <?php else: ?>
                        <span><?php echo e($permohonan->status); ?></span>
                    <?php endif; ?>
                </td>
                <td><?php echo e(\Illuminate\Support\Str::limit($permohonan->verifikasi_pd_teknis ?? '', 10)); ?></td>
                <td><?php echo e(\Illuminate\Support\Str::limit($permohonan->verifikasi_dpmptsp ?? '', 10)); ?></td>
                <td><?php echo e($permohonan->pengembalian ? \Carbon\Carbon::parse($permohonan->pengembalian)->format('d/m/Y') : '-'); ?></td>
                <td><?php echo e($permohonan->terbit ? \Carbon\Carbon::parse($permohonan->terbit)->format('d/m/Y') : '-'); ?></td>
                <td><?php echo e(\Illuminate\Support\Str::limit($permohonan->verifikator ?? '', 10)); ?></td>
            </tr>
...
<?php /**PATH C:\xampp\htdocs\sistem-perizinan\resources\views/permohonan/export-pdf-compact.blade.php ENDPATH**/ ?>